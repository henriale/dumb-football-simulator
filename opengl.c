...
{
  GLuint t = SOIL_load_OGL_texture(img, SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID,
...
void init(int argc, char **argv)
{
  ...
  drawOptions.flags = (CP_SPACE_DEBUG_DRAW_SHAPES | CP_SPACE_DEBUG_DRAW_CONSTRAINTS
...
void
DrawCircle(cpVect pos, cpFloat angle, cpFloat radius, cpSpaceDebugColor outline, cpSpaceDebugColor fill, cpDataPointer data)
{
